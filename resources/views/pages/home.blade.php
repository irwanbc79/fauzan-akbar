...
<div class="min-h-screen flex items-center justify-center text-center px-[5%] pt-24 pb-20 relative overflow-hidden"
    ...
    <div class="absolute bottom-0 left-0 right-0 w-full pointer-events-none overflow-hidden" style="height: 220px;">
        <img src="{{ asset('images/mosque-skyline-final.png') }}?v={{ time() }}" alt="" class="absolute bottom-0 left-1/2 -translate-x-1/2 h-auto" style="width: 140%; max-width: 2000px; opacity: 0.55; mix-blend-mode: luminosity;">
    </div>
